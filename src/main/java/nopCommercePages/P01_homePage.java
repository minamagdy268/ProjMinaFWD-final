...
public class P01_homePage extends PageBase {
    ...
    public WebElement firstSliderButton(){
        By firstSliderButton = By.xpath("//a[@rel=\"0\"]");
        return driver.findElement(firstSliderButton);
    }
    public WebElement firstSliderLink(){
        By firstSliderLink = By.xpath("(//a[@class=\"nivo-imageLink\"])[1]");
        return driver.findElement(firstSliderLink);
    }
    public WebElement secondSliderButton(){
        By secondSliderButton = By.xpath("//a[@rel=\"1\"]");
        return driver.findElement(secondSliderButton);
    }
    public WebElement secondSliderLink(){
        By secondSliderLink = By.xpath("(//a[@class=\"nivo-imageLink\"])[2]");
        return driver.findElement(secondSliderLink);
    }
